...
function setup(){
  ...
  Ground1 = new ground(width/2,height-25,largura,100);
  Ground = Bodies.rectangle(width/2,height-30,largura,100,sStatic);
  ...
  rabbit = Bodies.rectangle(600,height-120,150,150);
...
function draw() {
  ...
  Ground1.displayGround();//metodo displayGround criado na classe Ground
  Rope.Show();
  if(egg1 !==null){
